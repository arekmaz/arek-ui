...
const progressStyles = tv({
  slots: {
    ...
    range: [
      ...
      "duration-normal",
      "[--translate-x:-100%]",
      "data-[state=undeterminate]:animate-linear-indeterminate",
      "data-[state=undeterminate]:w-[210%]",
    ],
    circle: ["data-[state=undeterminate]:animate-spin"],
    circleTrack: ["stroke-muted"],
    circleRange: [
      "stroke-foreground",
      "transition-[stroke-dasharray,stroke]",
      "duration-slowest",
      "data-[state=undeterminate]:animate-circle-indeterminate",
    ],
    valueText: ["text-sm"],
    view: [],
  },
